...
export function BrandDNA({
  ...
  return (
    ...
    >
      ...
      />
      <div className="absolute inset-0 bg-[linear-gradient(125deg,rgba(255,255,255,0.04),transparent_26%,transparent_74%,rgba(255,255,255,0.03))]" />
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_0%,rgba(186,230,253,0.08),transparent_48%)]" />
      ...
      />
      <motion.div
        className="absolute left-1/2 top-[18%] h-[220px] w-px bg-gradient-to-b from-cyan-200/0 via-cyan-200/25 to-cyan-200/0"
        animate={
          canAnimate
            ? {
        ...
        transition={canAnimate ? { duration: 6.8, repeat: Infinity, ease: "easeInOut", delay: 0.2 } : undefined}
      />
      <div className="absolute left-[20%] top-[78%] h-[1px] w-32 bg-gradient-to-r from-transparent via-slate-300/35 to-transparent" />
      <div className="absolute right-[16%] top-[16%] h-24 w-24 rounded-full border border-cyan-200/8" />
      <div className="absolute right-[17.25%] top-[17.25%] h-[72px] w-[72px] rounded-full border border-cyan-200/10" />
    </div>
  );
}
